...
func _on_villain_shield_area_entered(area: Area2D) -> void:
			...
			if attack_index == 15:
				for _i in range(2):
					attack_pattern.append_array([
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.08),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 480, 0.3),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 630, 0.06),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 480, 0.5)
					])
				
				for _i in range(2):
					attack_pattern.append_array([
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.06),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 480, 0.3),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 630, 0.06),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 480, 0.5)
					])
				
				for _i in range(2):
					attack_pattern.append_array([
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.08),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 480, 0.3),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 630, 0.08),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.DOWN, 480, 0.5)
					])
				
				for _i in range(2):
					attack_pattern.append_array([
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.08),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.LEFT, 480, 0.3),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.1),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.UP, 630, 0.08),
						new_spear(SPEAR_TYPE.RED, SPEAR_DIRECTION.RIGHT, 480, 0.5)
					])
